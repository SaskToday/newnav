document.addEventListener('DOMContentLoaded', function() {
    ...
    const downArrow = `<svg class="desktop-down-arrow" style="width:20px; height:20px; margin-left:2px; flex-shrink:0;" viewBox="0 0 24 24"><path d="M7 10l5 5 5-5z" fill="currentColor"/></svg>`;
    ...
    <div id="village-nav-container">
        <style>
            ...
            @media (min-width: 991px) {
                ...
                .category-pill, #comm-container { background: transparent !important; border: none !important; border-radius: 0; padding: 8px 12px; font-size: 14px; }
