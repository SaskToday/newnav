    ...
    <div id="village-nav-container">
        <style>
            ...
            @media (min-width: 991px) {
                ...
                .category-pill.hover-active::after, #comm-container.hover-active::after { height: 4px; }
    ...
    function initHoverDropdowns() {
        ...
        pills.forEach(pill => {
            ...
            const show = () => {
                ...
                // Remove hover-active from all pills before adding to current one
                document.querySelectorAll('.category-pill, #comm-container').forEach(p => p.classList.remove('hover-active'));
