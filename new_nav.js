document.addEventListener('DOMContentLoaded', function() {
    ...
    <div id="village-nav-container">
        <style>
            ...
            .desktop-mega-menu { position: absolute; top: 100%; left: 0; right: 0; width: 100%; background: var(--nav-bg); max-height: 0; overflow: hidden; z-index: 1000; box-shadow: 0 4px 6px rgba(0,0,0,0.1); padding-top: 2px; }
    ...
    function initHoverDropdowns() {
        ...
        pills.forEach(pill => {
            ...
            const show = () => {
                ...
                // Position mega menu right at the bottom of the top row, accounting for separator
