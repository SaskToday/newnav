...
function initNavigationScript() {
    ...
    <div id="village-nav-container">
        <style>
            ...
            #bottom-trending-story-bar.next-read-stack-experiment .stack-newsletter-input { width: 100%; max-width: 280px; box-sizing: border-box; padding: 10px 12px; font-size: 14px; border: 1px solid #cbd5e1; border-radius: 8px; margin-bottom: 10px; }
            #bottom-trending-story-bar.next-read-stack-experiment .stack-newsletter-btn { margin-top: 4px; padding: 10px 20px; font-size: 14px; font-weight: 700; color: #fff; background: #830d16; border: 0; border-radius: 8px; cursor: pointer; }
