document.addEventListener('DOMContentLoaded', function() {
    ...
    <div id="village-nav-container">
        <style>
            ...
            @media (min-width: 991px) {
                .nav-backdrop-blur { position: fixed; top: 0; left: 0; right: 0; bottom: 0; backdrop-filter: blur(4px); background: rgba(0, 0, 0, 0.02); z-index: 9999998; pointer-events: none; opacity: 0; transition: opacity 0.2s; }
                .nav-backdrop-blur.visible { opacity: 1; }
            }
    ...
    function initHoverDropdowns() {
        ...
        backdrop.className = 'nav-backdrop-blur';
