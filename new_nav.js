    ...
    <div id="village-nav-container">
        <style>
            ...
            @media (min-width: 991px) {
                ...
                #comm-container::before { content: ""; position: absolute; right: -1px; top: 0; bottom: -2px; width: 1px; background-color: var(--separator-color); z-index: 1; opacity: 0.3; border-bottom-left-radius: 8px; }
                #village-nav-container.mega-menu-open #comm-container::before, #village-nav-container:has(.bottom-row.active) #comm-container::before { opacity: 0.5; bottom: -3px; }
