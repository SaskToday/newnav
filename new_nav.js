    ...
    <div id="village-nav-container">
        <style>
            ...
            @media (min-width: 991px) {
                ...
                #village-nav-container:not(:has(.bottom-row.active)) .top-row { padding-bottom: 20px; }
                ...
                .bottom-row-inner { padding-top: 10px !important; padding-bottom: 10px !important; padding-left: 12px !important; }
                .bottom-row-inner { padding: 10px 0 10px 12px !important; }
