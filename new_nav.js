...
function initNavigationScript() {
    ...
    const NEXT_READ_STACK_MAX_ITEMS = 3;
    ...
    const NEXT_READ_STACK_THEME = (window.NAV_NEXT_READ_STACK_DARK_MODE === true ? 'dark' : String(window.NAV_NEXT_READ_STACK_THEME || '')).toLowerCase();
    const NEXT_READ_STACK_FROSTED = window.NAV_NEXT_READ_STACK_FROSTED === true;
    ...
    <div id="village-nav-container">
        <style>
            ...
            #bottom-trending-story-bar.next-read-stack-experiment { display: block; left: 0; right: 0; width: 100%; padding: 10px 12px 0 12px; bottom: 0; border: 1px solid rgba(0,0,0,0.08); border-radius: 28px 28px 0 0; background: #fff; box-shadow: 0 10px 28px rgba(15,23,42,0.16); overflow: hidden; opacity: 1; transform: translateY(calc(100% + 24px)); transition: transform 0.28s cubic-bezier(0.25, 1, 0.5, 1); pointer-events: none; touch-action: none; box-sizing: border-box; will-change: transform; }
            #bottom-trending-story-bar.next-read-stack-experiment.visible { transform: translateY(var(--stack-translate-y)); pointer-events: auto; }
            #bottom-trending-story-bar.next-read-stack-experiment.is-dragging { transition: none !important; }
            #bottom-trending-story-bar.next-read-stack-experiment > * + * { margin-left: 0; }
            #bottom-trending-story-bar.next-read-stack-experiment .pull-handle { position: relative; width: 40px; height: 3px; border-radius: 999px; background: #cbd5e1; margin: 0 auto 16px auto; cursor: pointer; }
            ...
            #bottom-trending-story-bar.next-read-stack-experiment .stack-newsletter-input { flex: 1; min-width: 0; box-sizing: border-box; padding: 10px 12px; font-size: 14px; border: 1px solid #cbd5e1; border-radius: 8px; }
            #bottom-trending-story-bar.next-read-stack-experiment .stack-newsletter-btn { flex-shrink: 0; padding: 10px 20px; font-size: 14px; font-weight: 700; color: #fff; background: #830d16; border: 0; border-radius: 8px; cursor: pointer; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-dark { background: #111111; border-color: rgba(255,255,255,0.1); box-shadow: 0 10px 28px rgba(0,0,0,0.5); }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-dark .pull-handle { background: #555; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-dark .stack-title { color: #ef4444; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-dark .stack-link { color: #e5e7eb; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-dark .stack-link:hover { color: #6ee7b7; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-dark .stack-link.secondary { opacity: 0.7; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-dark .stack-link-index { color: #ef4444; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-dark .stack-editor-msg { border-bottom-color: #2a2a2a; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-dark .stack-editor-dot { border-color: #111111; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-dark .stack-editor-name { color: #f3f4f6; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-dark .stack-editor-title { color: #9ca3af; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-dark .stack-editor-body { color: #d1d5db; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-dark .stack-editor-body a { color: #ef4444; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-dark .stack-newsletter { border-top-color: #2a2a2a; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-dark .stack-newsletter-text { color: #9ca3af; }
            ...
            #bottom-trending-story-bar.next-read-stack-experiment.stack-yellow .pull-handle { background: rgba(0,0,0,0.25); }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-yellow .stack-title { color: #111827; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-yellow .stack-link { color: #111827; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-yellow .stack-link:hover { color: #4a2000; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-yellow .stack-link-index { color: #92400e; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-yellow .stack-editor-msg { border-bottom-color: rgba(0,0,0,0.12); }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-yellow .stack-editor-dot { border-color: #fbbf24; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-yellow .stack-editor-name { color: #111827; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-yellow .stack-editor-title { color: #78350f; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-yellow .stack-editor-body { color: #1c1917; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-yellow .stack-editor-body a { color: #92400e; font-weight: 700; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-yellow .stack-newsletter { border-top-color: rgba(0,0,0,0.12); }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-yellow .stack-newsletter-text { color: #78350f; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-yellow .stack-newsletter-input { background: rgba(255,255,255,0.6); border-color: rgba(0,0,0,0.15); color: #111827; }
            #bottom-trending-story-bar.next-read-stack-experiment.stack-yellow .stack-newsletter-btn { background: #111827; color: #fbbf24; }
        ...
        <div class="nav-content-wrapper">
            ...
            <div class="bottom-row" id="community-yorkton"><div class="bottom-row-inner hide-scrollbar"><a href="${base}/yorkton-today" class="text-link">All Yorkton</a><a href="${base}/yorkton-today/yorkton-news" class="text-link">Yorkton News</a><a href="${base}/obituaries/yorkton-obituaries" class="text-link">Yorkton Obituaries</a></div></div>
            ...
            <div class="bottom-row" id="community-kamsack"><div class="bottom-row-inner hide-scrollbar"><a href="${base}/kamsack-today" class="text-link">All Kamsack</a><a href="${base}/kamsack-today/kamsack-news" class="text-link">Kamsack News</a><a href="${base}/obituaries/kamsack-obituaries" class="text-link">Kamsack Obituaries</a></div></div>
            <div class="bottom-row" id="community-thebattlefords"><div class="bottom-row-inner hide-scrollbar"><a href="${base}/battlefords-today" class="text-link">All The Battlefords</a><a href="${base}/battlefords-today/battlefords-news" class="text-link">Battlefords News</a><a href="${base}/obituaries/battlefords-obituaries" class="text-link">Battlefords Obituaries</a></div></div>
            ...
            <div class="bottom-row" id="community-assiniboia"><div class="bottom-row-inner hide-scrollbar"><a href="${base}/assiniboia-today" class="text-link">All Assiniboia</a><a href="${base}/assiniboia-today/assiniboia-news" class="text-link">Assiniboia News</a><a href="${base}/obituaries/assiniboia-obituaries" class="text-link">Assiniboia Obituaries</a></div></div>
    ...
    async function fetchRssFeedData(rssUrl) {
        ...
        triggerPostHogRecording('nav_next_read_rss_fetched', { rss_url: String(rssUrl || '') });
    ...
    function extractCategoryNameFromRelatedHeading(headingEl) {
        if (!headingEl || !headingEl.textContent) return '';
        const raw = String(headingEl.textContent).trim();
        const lower = raw.toLowerCase();
        if (lower.startsWith('more ')) return raw.slice(5).trim();
        return raw;
    }

    function getNextReadRelatedArticlesFromDom() {
        const root = document.querySelector('.details-related');
        if (!root) return null;
        const heading = root.querySelector('h2.title');
        const categoryName = heading ? extractCategoryNameFromRelatedHeading(heading) : '';
        const anchors = root.querySelectorAll('a.section-item[href]');
        const items = [];
        anchors.forEach((anchor) => {
            ...
            const path = normalizePath(absolute.pathname);
            const tds = anchor.querySelectorAll('.section-td');
            const headlineCell = tds.length >= 2 ? tds[1] : null;
            if (!headlineCell) return;
            const clone = headlineCell.cloneNode(true);
            const intro = clone.querySelector('.section-intro');
    ...
    function getNextReadStackTitle() {
        ...
        const formatted = categoryName ? categoryName.split(/\s+/).map(w => w.charAt(0).toUpperCase() + w.slice(1).toLowerCase()).join(' ') : '';
        return formatted ? `New in ${formatted}` : 'New in';
    }
    ...
    function setNextReadStackState({ expanded = false, peeked = false } = {}) {
        if (NAV_STACK_DEBUG) {
            console.log('[NAV STACK DBG] setNextReadStackState', { expanded: !!expanded, peeked: !!peeked });
        }
        ...
        const stateKey = nextReadStackExpanded ? 'expanded' : (nextReadStackPeeked ? 'peek' : 'collapsed');
        const targetTY = getNextReadStackTranslateY(stateKey, expandedHeight);
    ...
    function getNextReadStackOverheadHeight() {
        const bar = getBottomTrendingBarElement();
        if (!bar) return 50;
        const shell = bar.querySelector('.stack-preview-shell');
        if (!shell) return 50;
        return Math.round(shell.offsetTop);
    }

    function getNextReadStackTranslateY(state, expandedShellHeight) {
        const eh = expandedShellHeight != null ? expandedShellHeight : getNextReadStackExpandedShellHeightPx();
        if (state === 'expanded') return 0;
        if (state === 'peek') return eh;
        return Math.max(0, eh - NEXT_READ_STACK_COLLAPSED_HEIGHT);
    }

    function getNextReadStackCurrentTranslateY() {
        const bar = getBottomTrendingBarElement();
        if (!bar) return 0;
        const st = bar.style.getPropertyValue('--stack-translate-y');
        if (st) return parseFloat(st) || 0;
        return 0;
    }
    ...
    function bindNextReadStackGestureHandlers() {
        ...
        document.addEventListener('touchstart', (event) => {
            ...
            nextReadStackDragStartTranslateY = getNextReadStackCurrentTranslateY();
        ...
        const finishGesture = () => {
            ...
            nextReadStackDragStartTranslateY = 0;
            nextReadStackDragDeltaY = 0;
            nextReadStackDragArmed = false;
        ...
        const finalizeGesture = () => {
            ...
            const finalTY = Math.max(0, Math.min(peekTY, nextReadStackDragStartTranslateY + deltaY));
            const peekThresholdTY = peekTY - 44;
            const range = collapsedTY;
            const expandSnap = range * (1 - NEXT_READ_STACK_EXPAND_SNAP_RATIO);
            const collapseSnap = range * (1 - NEXT_READ_STACK_COLLAPSE_SNAP_RATIO);
            let nextState = { expanded: false, peeked: false };
            if (finalTY >= peekThresholdTY) {
                nextState = { expanded: false, peeked: true };
            } else if (finalTY <= collapseSnap) {
                nextState = { expanded: true, peeked: false };
            } else if (finalTY >= expandSnap) {
            ...
            if (NAV_STACK_DEBUG) console.log('[NAV STACK DBG] finalizeGesture result', { nextState, deltaY, finalTY });
    ...
    function renderBottomTrendingStoryBar(nextItem) {
        ...
        if (isNextReadStackExperimentActive()) {
            ...
            bar.className = 'next-read-stack-experiment' + (NEXT_READ_STACK_THEME ? ' stack-' + NEXT_READ_STACK_THEME : '') + (NEXT_READ_STACK_FROSTED ? ' stack-frosted' : '');
            bar.innerHTML = '';
            bar.style.bottom = `${getBottomTrendingBottomOffset()}px`;
            bar.setAttribute('aria-label', getNextReadStackTitle());

            if (NEXT_READ_STACK_FROSTED) {
                const backdrop = document.createElement('div');
                backdrop.className = 'stack-backdrop';
            ...
            newsletterRow.className = 'stack-newsletter-row';
            newsletterRow.appendChild(newsletterInput);
            newsletterRow.appendChild(newsletterBtn);
            ...
            if (bottomTrendingVisibleState) bar.classList.add('visible');
    ...
    function applyBottomTrendingBarLayout() {
        ...
        if (!bar) return;
        const isStack = bar.classList.contains('next-read-stack-experiment');

        if (window.innerWidth <= 767) {
            if (bottomTrendingLayoutMode !== 'mobile') {
                bar.style.left = '';
                bar.style.right = '';
                if (!isStack) bar.style.transform = '';
                bar.style.width = '';
